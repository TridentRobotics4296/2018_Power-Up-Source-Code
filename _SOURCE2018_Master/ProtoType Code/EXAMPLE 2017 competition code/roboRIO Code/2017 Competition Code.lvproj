...
AddOutputFilter chunkFilter
		...
		<Item Name="Systems" Type="Folder">
			...
			<Item Name="Climber.lvlib" Type="Library" URL="../Systems/Climber/Climber.lvlib"/>
			<Item Name="Controller.lvlib" Type="Library" URL="../Systems/Controller/Controller.lvlib"/>
			<Item Name="DashBoardCom.lvlib" Type="Library" URL="../Systems/DashBoardCom/DashBoardCom.lvlib"/>
			<Item Name="Gear.lvlib" Type="Library" URL="../Systems/Gear/Gear.lvlib"/>
			<Item Name="Hopper System.lvlib" Type="Library" URL="../Systems/Hopper/Hopper System.lvlib"/>
			<Item Name="Intake.lvlib" Type="Library" URL="../Systems/Intake/Intake.lvlib"/>
			<Item Name="Joystick.lvlib" Type="Library" URL="../Joystick/Joystick.lvlib"/>
			<Item Name="LED Signal.lvlib" Type="Library" URL="../Systems/LED Signal/LED Signal.lvlib"/>
			<Item Name="MechamunDrive.lvlib" Type="Library" URL="../Systems/MechamumDrive/MechamunDrive.lvlib"/>
			<Item Name="Overlords.lvlib" Type="Library" URL="../Systems/Overlords/Overlords.lvlib"/>
			<Item Name="Shooter.lvlib" Type="Library" URL="../Systems/Shooter/Shooter.lvlib"/>
			<Item Name="Sonar.lvlib" Type="Library" URL="../Systems/Sonar/Sonar.lvlib"/>
			<Item Name="VisionSystem.lvlib" Type="Library" URL="../Systems/VisionSystem/VisionSystem.lvlib"/>
		</Item>
		<Item Name="Overlords" Type="Folder">
			<Item Name="Aim&amp;ShootOverlord.lvlib" Type="Library" URL="../Overlords/Aim&amp;Shoot_Overlord/Aim&amp;ShootOverlord.lvlib"/>
		</Item>
		<Item Name="Globals" Type="Folder">
			<Item Name="Global_STOP.vi" Type="VI" URL="../Globals/Global_STOP.vi"/>
			<Item Name="Global_CMD_Shooter.vi" Type="VI" URL="../Globals/Global_CMD_Shooter.vi"/>
			<Item Name="Global_HoodSensorPos.vi" Type="VI" URL="../Globals/Global_HoodSensorPos.vi"/>
			<Item Name="Global_CMD to Gear.vi" Type="VI" URL="../Globals/Global_CMD to Gear.vi"/>
			<Item Name="Global_CMD Desired Climber Mode.vi" Type="VI" URL="../Globals/Global_CMD Desired Climber Mode.vi"/>
			<Item Name="Global_Alliance.vi" Type="VI" URL="../Globals/Global_Alliance.vi"/>
			<Item Name="Global_Main CPU Percent.vi" Type="VI" URL="../Globals/Global_Main CPU Percent.vi"/>
		</Item>
		<Item Name="TypeDefs" Type="Folder">
			<Item Name="ENUM_Controler Axis List.ctl" Type="VI" URL="../TypeDefs/ENUM_Controler Axis List.ctl"/>
			<Item Name="ENUM_Controler Button List.ctl" Type="VI" URL="../TypeDefs/ENUM_Controler Button List.ctl"/>
			<Item Name="Cluster_SRX PID Values.ctl" Type="VI" URL="../TypeDefs/Cluster_SRX PID Values.ctl"/>
			<Item Name="ENUM_CMD Shooter Select.ctl" Type="VI" URL="../TypeDefs/ENUM_CMD Shooter Select.ctl"/>
			<Item Name="Cluster_CMD Shooter Data.ctl" Type="VI" URL="../TypeDefs/Cluster_CMD Shooter Data.ctl"/>
			<Item Name="Cluster_PID Constants Standard.ctl" Type="VI" URL="../TypeDefs/Cluster_PID Constants Standard.ctl"/>
			<Item Name="Cluster_SRX Status With Encoder.ctl" Type="VI" URL="../TypeDefs/Cluster_SRX Status With Encoder.ctl"/>
			<Item Name="Cluster_SRX Status No Encoder.ctl" Type="VI" URL="../TypeDefs/Cluster_SRX Status No Encoder.ctl"/>
			<Item Name="Cluster_SRX Limit Switches.ctl" Type="VI" URL="../TypeDefs/Cluster_SRX Limit Switches.ctl"/>
			<Item Name="Enum_JoystickButtonFunctions.ctl" Type="VI" URL="../Systems/Controller/Enum_JoystickButtonFunctions.ctl"/>
			<Item Name="Enum_ButtonBoardFunctions(buttons).ctl" Type="VI" URL="../Systems/Controller/Enum_ButtonBoardFunctions(buttons).ctl"/>
			<Item Name="Cluster_Camera Settings.ctl" Type="VI" URL="../TypeDefs/Cluster_Camera Settings.ctl"/>
			<Item Name="ENUM_Overloard States.ctl" Type="VI" URL="../TypeDefs/ENUM_Overloard States.ctl"/>
			<Item Name="ENUM_Overloard Shooter States.ctl" Type="VI" URL="../TypeDefs/ENUM_Overloard Shooter States.ctl"/>
			<Item Name="ENUM_Shooter column Lookup table.ctl" Type="VI" URL="../TypeDefs/ENUM_Shooter column Lookup table.ctl"/>
		</Item>
		<Item Name="Team Code" Type="Folder">
			...
			<Item Name="Mason Messy Teleop.vi" Type="VI" URL="../Mason Messy Teleop.vi"/>
			<Item Name="Test.vi" Type="VI" URL="../Test.vi"/>
			<Item Name="Vision Processing.vi" Type="VI" URL="../Vision Processing.vi"/>
			<Item Name="Determine Teleop State.vi" Type="VI" URL="../Determine Teleop State.vi"/>
		</Item>
		<Item Name="System Templates" Type="Folder">
			<Item Name="TemplateActuator.lvlib" Type="Library" URL="../Templates/TemplateActuator/TemplateActuator.lvlib"/>
			<Item Name="TemplateSensor.lvlib" Type="Library" URL="../Templates/TemplateSensor/TemplateSensor.lvlib"/>
			<Item Name="TemplateOverlord.lvlib" Type="Library" URL="../Templates/TemplateOverlord/TemplateOverlord.lvlib"/>
		</Item>
		...
		<Item Name="Autonomous" Type="Folder">
			<Item Name="Enum_AutoState.ctl" Type="VI" URL="../Autonomous/Enum_AutoState.ctl"/>
			<Item Name="Enum_AutoAction.ctl" Type="VI" URL="../Autonomous/Enum_AutoAction.ctl"/>
		</Item>
		<Item Name="Experimental" Type="Folder">
			<Item Name="Teleop-MAY.vi" Type="VI" URL="../Teleop-MAY.vi"/>
		</Item>
		...
		<Item Name="Dependencies" Type="Dependencies">
			...
			<Item Name="CTRE_Phoenix_MotorController_GetFaults.vi" Type="VI" URL="../../../../System Drivers/Phoenix-LabVIEW/Motor Controller/Errors and Faults/CTRE_Phoenix_MotorController_GetFaults.vi"/>
			<Item Name="CTRE_Phoenix_MotorController_GetStickyFaults.vi" Type="VI" URL="../../../../System Drivers/Phoenix-LabVIEW/Motor Controller/Errors and Faults/CTRE_Phoenix_MotorController_GetStickyFaults.vi"/>
			<Item Name="CTRE_Phoenix_MotorController_GetLastError.vi" Type="VI" URL="../../../../System Drivers/Phoenix-LabVIEW/Motor Controller/Errors and Faults/CTRE_Phoenix_MotorController_GetLastError.vi"/>
		...
		<Item Name="Build Specifications" Type="Build">
			<Item Name="FRC Robot Boot-up Deployment" Type="{69A947D5-514E-4E75-818E-69657C0547D8}">
				...
				<Property Name="Bld_localDestDir" Type="Path">../Builds/roboRIO Builds</Property>
				...
				<Property Name="Source[0].itemID" Type="Str">{C6486E2B-9236-4CD3-81D5-875557D74865}</Property>
